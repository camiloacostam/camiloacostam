### Hi there 👋! I'm Camilo Acosta
<!--  ╔══════════════════════════════════════════╗  -->
<!--  ║   GitHub Profile README — Camilo Acosta  ║  -->
<!--  ╚══════════════════════════════════════════╝  -->
...
🚀 &nbsp;Creo webs que enamoran y convierten de verdad
🎨 &nbsp;Especialista en UI/UX para profesionales independientes
📍 &nbsp;Basado en Cartagena, trabajando para el mundo
✍️ &nbsp;Escribo sobre IA, Marketing y Desarrollo en mi blog
☕ &nbsp;Fan del café, el buen diseño y las webs rápidas
...
```javascript
const camilo = {
  rol: "Full Stack Designer",
  ciudad: "Cartagena 🇨🇴",
  stack: ["Astro", "React", "Next.js"],
  diseño: ["Figma", "Tailwind"],
  open: true,
};
```
...
![Pencil](https://img.shields.io/badge/Pencil-7C3AED?style=flat-square&logoColor=white)
...
[Ver proyecto →](https://camiloacosta.dev/proyectos)
...
<!-- BLOG:START -->
> 📝 Los primeros artículos están en camino. Próximamente en [camiloacosta.dev/blog](https://camiloacosta.dev/blog)
<!-- BLOG:END -->
...
¿Tienes un proyecto en mente o quieres tomar un café virtual? Escríbeme 👇
